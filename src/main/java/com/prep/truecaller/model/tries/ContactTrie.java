package main.java.com.prep.truecaller.model.tries;
...
public class ContactTrie {
    ...
    public int countNumOfChildren(TrieNode trieTrieNode) {
        int numOfChildren = 0;
    ...
    public void getSuffixes(TrieNode trieNode, String prefix, List<String> allWords) {
