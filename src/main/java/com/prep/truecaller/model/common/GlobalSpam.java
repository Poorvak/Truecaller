package main.java.com.prep.truecaller.model.common;
...
import static main.java.com.prep.truecaller.model.common.Constant.MAX_COUNT_TO_MARK_GLOBAL_BLOCKED;
import static main.java.com.prep.truecaller.model.common.Constant.MAX_GLOBAL_SPAM_COUNT;
...
public class GlobalSpam {
    ...
    private CountingBloomFilter<String> globalSpam = new FilterBuilder(MAX_GLOBAL_SPAM_COUNT, .01).buildCountingBloomFilter();
